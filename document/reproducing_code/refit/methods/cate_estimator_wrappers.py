...
class CATEEstimatorResults:
    ...
    def __init__(self, train_indices, val_indices, CATE_estimator, 
                 save_metalearner = False, seed = 123123):
...
class RLearnerWrapper(BaseCATEEstimatorWrapper):
    ...
    def _make_meta_learner(self):
        ...
        Helper function that initializes the metalearner object
        """
        n_fold = getattr(self, "r_n_fold", 5)
        cv_n_jobs = getattr(self, "r_cv_n_jobs", None)
        self.meta_learner = self.meta_learner_class(outcome_learner = 
                                                    self.outcome_learner, 
                                                    effect_learner = 
                                                    self.effect_learner,
                                                    n_fold = n_fold)
        if cv_n_jobs is not None:
            self.meta_learner.cv_n_jobs = cv_n_jobs
    ...
    def set_params(self, params):
        ...
        self.r_n_fold = params.get("r_n_fold", getattr(self, "r_n_fold", 5))
        self.r_cv_n_jobs = params.get("r_cv_n_jobs", getattr(self, "r_cv_n_jobs", None))
        self._make_meta_learner()
    ...
    def get_params(self):
        ...
        return {"outcome_learner" : self.outcome_learner.get_params(),
                ...
                "r_n_fold" : getattr(self, "r_n_fold", 5),
                "r_cv_n_jobs" : getattr(self, "r_cv_n_jobs", None)}
